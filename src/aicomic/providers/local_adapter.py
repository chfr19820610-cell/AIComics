...
def get_comfyui_settings(settings: dict, providers_config_path: Path, payload: dict, provider: str) -> dict:
    ...
    return {
        ...
        "model_root": resolve_config_path(str(os.environ.get("AICOMIC_COMFYUI_MODEL_ROOT", section.get("model_root", "../local_providers/comfyui_runtime/ComfyUI/models"))), providers_config_path.parent),
        "model_manifest_path": resolve_config_path(str(os.environ.get("AICOMIC_COMFYUI_MODEL_MANIFEST_PATH", section.get("model_manifest_path", "../local_providers/comfyui_runtime/model_requirements.json"))), providers_config_path.parent),
